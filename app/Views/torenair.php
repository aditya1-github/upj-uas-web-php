		...
		<div class="row topspace">
			...
			<article class="col-sm-8 maincontent">
				<header class="page-header">
					<h1 class="page-title">Project Membersihkan toren air.</h1>
				</header>

				<p><img src="<?= base_url() ?>/template/assets/images/s1.jpg" alt=""></p>

				<p>Tak hanya sekadar kebutuhan air bersih, toren air yang kaya akan lumut dan tercemar juga pastinya tidak baik untuk kesehatan tubuh.

Adapun, selain saluran air bersih berfungsi dengan maksimal, toren air juga harus dalam keadaan bersih sehingga kamu bisa gunakan untuk mandi maupun mencuci pakaian.</p>
